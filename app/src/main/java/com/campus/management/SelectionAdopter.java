...
public class SelectionAdopter extends RecyclerView.Adapter<SelectionAdopter.MyViewHolder1>  {

    private Context mcontext;
    private List<Student> students;
    //private List<Shop> shopList;
    //constructor
    public SelectionAdopter(Context mcontext, List<Student> students) {
    ...
    public void onBindViewHolder(MyViewHolder1 holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mcontext, FeeManager.class);
